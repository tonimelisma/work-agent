...
| [llm-provider-registries.md](llm-provider-registries.md) | models.dev and alternatives; live API measurements, gaps, and the incorrect Thinking Machines preset | 2026-07-22 |
...
| [provider-chat-endpoints.md](provider-chat-endpoints.md) | Live-probed chat endpoint, auth, and reasoning-field details per curated provider | 2026-07-22 |
