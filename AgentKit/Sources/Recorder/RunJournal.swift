...
// truth, storage-protocol first so the app can choose the concrete store (this
// increment ships a file-backed implementation; SwiftData is the app's own
// persistence choice per ADR-0008 and does not have to be this protocol's backing).
