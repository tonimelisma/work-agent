...
/// Versioned host persistence around Apple's Codable transcript.
public struct TranscriptArchive: Codable, Sendable {
    ...
    /// This is the mechanism a host's automatic cross-provider failover reconstructs a session on.
